...
<head>
    ...
    <title>Barang Keluar Bar — Vosale</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a href="{{ route('bar.stock.out') }}" class="nav-link active">
    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                <h5 class="mb-0 fw-bold">Barang Keluar — Bar</h5>
                <small class="text-muted">Catat penggunaan/pengeluaran stok</small>
            </div>
        </div>
        ...
        <div class="card card-main p-4 mb-4">
            ...
            <form method="POST" action="{{ route('bar.stock.out.store') }}">
                @csrf
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="note" class="form-control"
                            placeholder="contoh: Digunakan untuk event"
                            value="{{ old('note') }}">
                    </div>
                    <div class="col-md-3">
                        <div id="stock_info" class="stock-info mb-2 d-none">
                            Stok tersedia: <strong id="current_stock" class="text-success">0</strong> <span id="unit_label"></span>
                        </div>
        ...
        <div class="card card-main">
            <div class="card-header bg-white border-0 pt-4 px-4">
                <h6 class="fw-bold mb-0">Riwayat Barang Keluar</h6>
            </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-danger">-{{ $trx->quantity }} {{ $trx->item->unit ?? '' }}</span>
                            </td>
    ...
    <script>
        function updateStockInfo(select) {
            ...
            if (select.value) {
                ...
                stockEl.className = parseInt(stock) <= 5 ? 'text-danger fw-bold' : 'text-success fw-bold';
