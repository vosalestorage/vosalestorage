...
<head>
    ...
    <title>Barang Masuk Bar — Vosale</title>
...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a href="{{ route('bar.stock.in') }}" class="nav-link active">
    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                <h5 class="mb-0 fw-bold">Barang Masuk — Bar</h5>
                <small class="text-muted">Catat penambahan stok barang</small>
            </div>
        </div>
        ...
        <div class="card card-main p-4 mb-4">
            ...
            <form method="POST" action="{{ route('bar.stock.in.store') }}">
                @csrf
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        <div id="stock_info" class="stock-info mb-2 d-none">
                            Stok saat ini: <strong id="current_stock">0</strong> <span id="unit_label"></span>
                        </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-success">+{{ $trx->quantity }} {{ $trx->item->unit ?? '' }}</span>
                            </td>
    ...
    <script>
        ...
        // Auto trigger jika ada old value
