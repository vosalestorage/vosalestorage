...
<head>
    ...
    <title>Tambah Barang Bar — Vosale</title>
...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                <h5 class="mb-0 fw-bold">Tambah Barang Bar</h5>
                <small class="text-muted">Isi form untuk menambah barang baru</small>
            </div>
        ...
        <div class="card card-main p-4">
            ...
            <form method="POST" action="{{ route('bar.items.store') }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Nama Barang <span class="text-danger">*</span></label>
                        <input type="text" name="name" class="form-control"
                            value="{{ old('name') }}" placeholder="contoh: Sirup Marjan" required>
                    </div>
                    <div class="col-md-6">
