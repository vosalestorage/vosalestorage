...
<div class="sidebar">
    ...
    <nav class="nav flex-column mt-3">
        ...
        <a href="/kitchen/report" class="nav-link active">
...
<div class="main-content">
    ...
    <div class="topbar">
        <div>
            <h5 class="mb-0 fw-bold">Statistik Kitchen</h5>
            <small class="text-muted">Laporan dan grafik inventaris dapur</small></div><div class="d-flex gap-2"><a href="/kitchen/export/excel" class="btn btn-success btn-sm"><i class="bi bi-file-earmark-excel me-1"></i>Export Excel</a><a href="/kitchen/export/pdf" class="btn btn-danger btn-sm"><i class="bi bi-file-earmark-pdf me-1"></i>Export PDF</a>
        </div>
    </div>
