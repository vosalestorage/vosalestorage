...
<title>Data Barang Kitchen</title>
...
<div class="topbar">
<div><h5 class="mb-0 fw-bold">Data Barang Kitchen</h5><small class="text-muted">Kelola inventaris dapur</small></div>
<a href="/kitchen/items/create" class="btn btn-warning btn-sm"><i class="bi bi-plus-circle me-1"></i> Tambah Barang</a>
</div>
...
<form method="GET" action="/kitchen/items">
<div class="row g-2 align-items-end">
    ...
    <div class="col-md-2 d-flex gap-2">
        <button type="submit" class="btn btn-warning w-100"><i class="bi bi-funnel me-1"></i>Filter</button>
        <a href="/kitchen/items" class="btn btn-outline-secondary w-100"><i class="bi bi-x"></i></a>
    </div>
</div>
</form>
</div>
...
<a href="/kitchen/items/{{ $item->id }}/edit" class="btn btn-sm btn-outline-warning me-1"><i class="bi bi-pencil"></i></a>
<form action="/kitchen/items/{{ $item->id }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus?')">
@csrf @method('DELETE')
