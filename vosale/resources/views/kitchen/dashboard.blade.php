...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Kitchen — Vosale</title>
...
<div class="main-content">
    ...
    <div class="topbar">
        ...
        <div>
            ...
            <h5 class="mb-0 fw-bold">Dashboard Kitchen</h5>
            <small class="text-muted">
                Selamat datang, {{ auth()->user()->name }}
            </small>
        </div>

        <span class="badge bg-danger">Admin Kitchen</span>
    </div>
        ...
        <div class="col-md-3">
            <div class="card card-stat p-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="text-muted" style="font-size:.8rem">Masuk Hari Ini</div>
        ...
        <div class="col-md-3">
            <div class="card card-stat p-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="text-muted" style="font-size:.8rem">Keluar Hari Ini</div>
        ...
        <div class="col-12">
            <div class="card card-stat p-4">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <a href="/kitchen/items/create" class="btn btn-warning">
                        <i class="bi bi-plus-circle me-1"></i> Tambah Data Barang
                    </a>

                    <a href="/kitchen/stock/in" class="btn btn-success">
                        <i class="bi bi-arrow-down-circle me-1"></i> Catat Barang Masuk
                    </a>

                    <a href="/kitchen/stock/out" class="btn btn-danger">
    ...
    <div class="card card-stat p-4">
        ...
        @else
            ...
            <div class="text-center text-muted py-4">
                ...
                <a href="/kitchen/items/create" class="btn btn-warning btn-sm">
                    Tambah Barang
                </a>
            </div>
