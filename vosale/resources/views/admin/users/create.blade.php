...
<title>Tambah User — Vosale</title>
...
<div class="topbar">
<div><h5 class="mb-0 fw-bold">Tambah User</h5><small class="text-muted">Buat akun pengguna baru</small></div>
...
<div class="col-md-6">
    ...
    <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="contoh: Admin Bar" required>
</div>
<div class="col-md-6">
...
<div class="col-md-6">
    ...
    <select name="role" class="form-select" required>
        ...
        <option value="bar" {{ old('role')=='bar'?'selected':'' }}>Admin Bar</option>
        <option value="kitchen" {{ old('role')=='kitchen'?'selected':'' }}>Admin Kitchen</option>
    </select>
</div>
<div class="col-12 d-flex gap-2 justify-content-end mt-2">
    <a href="/admin/users" class="btn btn-outline-secondary">Batal</a>
    <button type="submit" class="btn btn-danger px-4"><i class="bi bi-save me-1"></i> Simpan User</button>
</div>
</div>
</form>
</div>
